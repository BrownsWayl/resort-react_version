        ...
        <section className="filter-container">
            ...
            <form className='filter-form'>
                ...
                <div className="form-group">
                    ...
                    <input type="number" className='size-input' name='minSize'  onChange={handleChange} value={minSize} />
                    <input type="number" className='size-input' name='maxSize'  onChange={handleChange} value={maxSize} />
                </div>
                <div className="form-group">
